...
#     # Create a new ledger
#     ledger = Ledger.objects.create(name='Main Financial Ledger')

#     # Create a journal entry
#     journal_entry = JournalEntry.objects.create(
#         ledger=ledger, description="Initial transaction"
#     )

#     # Add transactions (debit/credit entries)
#     FinancialTransaction.objects.create(
#         ledger=ledger, description="Revenue from service", amount=1000.00
#     )
#     FinancialTransaction.objects.create(
#         ledger=ledger, description="Business expense", amount=-500.00
#     )

#     return render(request, 'finances/ledger.html', {'ledger': ledger})
